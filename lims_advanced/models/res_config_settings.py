...
class ResConfigSettings(models.TransientModel):
    ...
    group_lims_laboratory = fields.Boolean(
        string="Manage Laboratories",
        implied_group="lims_advanced.group_lims_laboratory",
    )
    group_lims_team = fields.Boolean(
        string="Manage Teams", implied_group="lims_advanced.group_lims_team"
    )
    group_lims_category = fields.Boolean(
        string="Manage Categories", implied_group="lims_advanced.group_lims_category"
    )
    group_lims_tag = fields.Boolean(
        string="Manage Tags", implied_group="lims_advanced.group_lims_tag"
    )
    group_lims_instrument = fields.Boolean(
        string="Manage Instruments", implied_group="lims_advanced.group_lims_instrument"
    )
    group_lims_batch = fields.Boolean(
        string="Manage Batches", implied_group="lims_advanced.group_lims_batch"
    )
    ...
    module_lims_bromatology = fields.Boolean(string="Use Bromatology")
